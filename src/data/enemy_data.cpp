...
EnemyDatabase::EnemyDatabase() {
    ...
    { "Mimic",
      ...
      {"A cursed chest that lies in wait for greedy adventurers, revealing rows of fangs the moment treasure is within reach."},
      1, {}, 1, {Dungeon, Terrain} },
    ...
    { "Direwolf",
      ...
      {"Direwolves are fierce predators that hunt in packs, their eyes glowing with feral hunger."},
      1, {}, 2, {Terrain} },
    ...
    { "Outlaw",
      ...
      {"A ruthless Outlaw, ambushing travelers on cursed roads for their souls."},
    ...
    { "Blood Bats",
      ...
      {"Bloodthirsty bats that descend in frenzied swarms, draining the life from anything they can sink their fangs into."},
      2, {}, 2, {Dungeon} },
    ...
    { "Warlock",
      ...
      {"A master of forbidden sorcery, wielding sinister spells that corrupt both body and soul."},
